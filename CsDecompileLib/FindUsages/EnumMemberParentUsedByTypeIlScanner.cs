...
public class EnumMemberParentUsedByTypeIlScanner : IMetadataUsagesScanner<IMember>
{
    private readonly AnalyzerScope _analyzerScope;
    private readonly TypeUsedByTypeIlScanner _typeScanner;

    public EnumMemberParentUsedByTypeIlScanner(
        AnalyzerScope analyzerScope,
        TypeUsedByTypeIlScanner typeScanner)
    {
    ...
    public IEnumerable<ITypeDefinition> GetRootTypesThatUseSymbol(IMember enumMember)
    {
        var analyzedSymbol = enumMember.DeclaringTypeDefinition;
        var result2 = _typeScanner.GetRootTypesThatUseSymbol(analyzedSymbol);
        return result2;
