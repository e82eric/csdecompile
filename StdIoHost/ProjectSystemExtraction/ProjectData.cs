...
internal class ProjectData
{
    ...
    public static ProjectData Create(Microsoft.Build.Evaluation.Project project)
    {
    ...
    public static ProjectData Create(string projectFilePath, Microsoft.Build.Execution.ProjectInstance projectInstance, Microsoft.Build.Evaluation.Project project)
    {
    ...
    private static RuleSet ResolveRulesetIfAny(Microsoft.Build.Execution.ProjectInstance projectInstance)
    {
    ...
    private static ImmutableArray<string> GetFullPaths(IEnumerable<Microsoft.Build.Execution.ProjectItemInstance> items, Func<string, bool> filter = null)
    {
    ...
    private static ImmutableArray<PackageReference> GetPackageReferences(ICollection<Microsoft.Build.Execution.ProjectItemInstance> items)
    {
