...
internal class DotNetCliService : IDotNetCliService
{
    ...
    public DotNetCliService(ILoggerFactory loggerFactory, IEventEmitter eventEmitter, string targetDirectory)
    {
        ...
        foreach (var path in new OmniSharpExtensionsOptions().GetNormalizedLocationPaths(targetDirectory))
        {
