...
internal static class IEventEmitterExtensions
{
    ...
    public static void UnresolvedDepdendencies(this IEventEmitter emitter, string projectFilePath,
        IEnumerable<OmniSharp.Models.Events.PackageDependency> unresolvedDependencies)
    {
        emitter.Emit(
